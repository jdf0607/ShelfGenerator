...
public class BacktrackingTest {
    ...
    public void testExecute() {
        List<Product> productListExpected = new ArrayList<>(Arrays.asList(p1, p6, p7, p10, p4, p9, p3, p5, p8, p2));
        ...
        assertEquals(productListExpected, productlist, "Solucion incorrecta");
    }
    ...
    public void testExecuteTwoProducts() {
        ...
        Map<Pair<Integer,Integer>,Double> setSimilarities = Map.of();
        List<Product> productlist = backtracking.execute(twoProduct,tags, setSimilarities);
        assertEquals(productListExpected, productlist, "Solucion incorrecta");
    }

    @Test
    public void testExecuteWithFixedSimilarities() {
        List<Product> productListExpected = new ArrayList<>(Arrays.asList(p1, p2, p8, p5, p3, p6, p7, p10, p4, p9));
    ...
    public void testEmptyProductList() {
        ...
        List<Product> result = backtracking.execute(emptyList, Map.of(), new HashMap<>());
    ...
    public void testSingleProduct() {
        ...
        List<Product> expected = new ArrayList<>(Arrays.asList(p1));
        List<Product> result = backtracking.execute(singleProduct, tags, new HashMap<>());
